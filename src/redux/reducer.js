...
const initialState = {
    ...
    greeting: 'Hello! This application will help you to keep abreast of current news. To use ' +
            'individual filters please log in.',
    individualGreeting: 'Glad to see you again! Good news for you - news filters have been added to the' +
            ' news section.',
